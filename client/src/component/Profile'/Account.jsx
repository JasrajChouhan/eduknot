    ...
    <div>
      <div class="p-4">
        ...
        <p class="mt-3 text-sm text-gray-600">
          Your Abc id is : <span className="font-bold">{props.id} </span>
          
          <br/>
          <br/>
          Your enrollement Number is : <span className="font-bold">{props.env}</span> 
          <br/>
        ...
        <div class="mt-3 flex items-center space-x-2">
          ...
          <span class="flex flex-col">
            ...
            <span class="text-[8px] font-medium text-gray-500">{`@${props.user_name}`}</span>
          </span>
        </div>
      </div>
    </div>
